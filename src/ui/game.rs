...
pub fn show(ui: &mut egui::Ui, app: &App) {
    match app.game {
        ...
        games::Game::Gi => {
            ...
            if ui.button("Inventory Exporter: filtered artifacts & equipped characters").clicked() {
            ...
            if ui.button("Inventory Exporter: filtered artifacts & without characters").clicked() {
            ...
            if ui.button("Inventory Exporter: all artifacts & equipped characters").clicked() {
